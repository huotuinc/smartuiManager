...
<body>
    ...
    <div id="toolbar">
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:add()">新增</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="javascript:edit()">编辑</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:deleteType()">删除</a>

    </div>
    <div id="win" class="easyui-window" title="新增分类" closed="true" style="width:300px;height:200px;">
    	<form id="fm" method="post">
    		<table border="0"   cellpadding="0"   cellspacing="5">
                ...
                <tr>
                    <td>范畴：</td>
                    <td><input type="radio" name="scopeName" value="global" id="global"/>商户
                    <input type="radio" name="scopeName" value="sis" id="sis"/>店中店
                    <input type="radio" name="scopeName" value="system" id="system"/>系统默认
                    </td>
                </tr>
    		</table>
    	</form>
    	<div style="padding:20px;text-align:center;">
                <a href="#" class="easyui-linkbutton" icon="icon-ok"onclick="saveType()">保存</a>
                <a href="#" class="easyui-linkbutton" icon="icon-cancel"onclick="closeWin()">取消</a>
         </div>
    </div>
    <div id="win2" class="easyui-window" title="上传附件" closed="true" style="width:300px;height:200px;text-align:center;">
    	...
    	<div style="padding:20px;text-align:center;">
                <a href="#" class="easyui-linkbutton" icon="icon-ok"onclick="upload()">上传</a>
                <a href="#" class="easyui-linkbutton" icon="icon-cancel"onclick="closeWin2()">取消</a>
         </div>
    </div>
</body>
</html>