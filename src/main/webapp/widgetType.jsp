...
<head>
    ...
    <script type="text/javascript">
                        ...
                        formatter: function (value, rec) {
                            if (null != rec.scope) {
                                if (rec.scope == "global") {
                                    ...
                                    return "系统默认";
                                }else if (rec.scope == "common") {
                                    return "公共";
                                }else if (rec.scope == "agent") {
                                    return "代理商";
                                }else if (rec.scope == "supplier") {
                                    return "供应商";
                                }
                            }
                            else
            ...
            if (isEdit) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        "scopeName": $("input[name='scopeName']:checked").val()
                    },
        ...
        function edit() {
            ...
            } else if (record.scope == "common") {
                $("#common").prop("checked", true);
            } else if (record.scope == "agent") {
                $("#agent").prop("checked", true);
            } else if (record.scope == "supplier") {
                ...
                <td><input type="radio" name="scopeName" value="global"
                           id="global"/>商户 <input type="radio" name="scopeName" value="sis"
                                                  id="sis"/>店中店 <input type="radio" name="scopeName" value="system"
                                                                       id="system"/>系统默认<br/>
                    <input type="radio" name="scopeName" value="common"
                           id="common"/>公共
